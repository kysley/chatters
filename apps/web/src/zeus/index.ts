...
export type ValueTypes = {
    ["Chatter"]: AliasType<{
	id?:boolean,
	occurances?:ValueTypes["Occurance"],
	username?:boolean,
		__typename?: boolean
}>;
	["Emote"]: AliasType<{
	...
	["Occurance"]: AliasType<{
	chatter?:ValueTypes["Chatter"],
	emote?:ValueTypes["Emote"],
	id?:boolean,
	uses?:boolean,
		__typename?: boolean
}>;
...
export type ModelTypes = {
    ["Chatter"]: {
		id:string,
	occurances:ModelTypes["Occurance"][],
	username:string
};
	["Emote"]: {
		code:string,
...
export type GraphQLTypes = {
	...
	__typename: "Chatter",
	id: string,
	occurances: Array<GraphQLTypes["Occurance"]>,
	username: string
};
	["Emote"]: {
	__typename: "Emote",
	...
	["Occurance"]: {
	__typename: "Occurance",
	chatter: GraphQLTypes["Chatter"],
	emote: GraphQLTypes["Emote"],
	id: string,
	uses: number
};
	["Query"]: {
